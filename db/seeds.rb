...
# t.boolean :admin
User.destroy_all
u1 = User.create(:name => 'Jose P', :email => '100@abc.com', :password => 'chicken', :admin => true)
u2 = User.create(:name => 'Sam C', :email => '200@abc.com', :password => 'chicken', :admin => true)
u3 = User.create(:name => 'Morgan G ', :email => '300@abc.com', :password => 'chicken', :admin => true)
u4 = User.create(:name => 'Sally Jones', :email => '400@abc.com', :password => 'chicken')
u5 = User.create(:name => 'Megan Long', :email => '500@abc.com', :password => 'chicken')
u6 = User.create(:name => 'Tom Shaws', :email => '600@abc.com', :password => 'chicken')
...
p9 = Planet.create(:name => 'Pluto', :distance_sun => 5984, :radius_orbit => 30.1, :radius_planet => 1188, :orbit_sun => 248, :num_moon => 5, :image =>'https://upload.wikimedia.org/wikipedia/commons/thumb/2/2a/Nh-pluto-in-true-color_2x_JPEG-edit-frame.jpg/450px-Nh-pluto-in-true-color_2x_JPEG-edit-frame.jpg', :info => 'Pluto (minor-planet designation: 134340 Pluto) is a dwarf planet in the Kuiper belt, a ring of bodies beyond Neptune. It was the first Kuiper belt object to be discovered. Pluto was discovered by Clyde Tombaugh in 1930 and was originally considered to be the ninth planet from the Sun. After 1992, its status as a planet was questioned following the discovery of several objects of similar size in the Kuiper belt. In 2005, Eris, a dwarf planet in the scattered disc which is 27% more massive than Pluto, was discovered. This led the International Astronomical Union (IAU) to define the term "planet" formally in 2006, during their 26th General Assembly. That definition excluded Pluto and reclassified it as a dwarf planet.')
